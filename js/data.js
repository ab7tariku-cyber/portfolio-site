...
const WORK_DATA = [
  ...
  { name: 'Gara Innovational Bootcamp', category: 'Social Media', slug: 'gara-innovational-bootcamp', image: 'assets/hero-gara-innovational-bootcamp.png', placeholder: 'Gara Innovational Bootcamp post', hasCaseStudy: true },
  ...
  { name: 'HU Fellow Posts', category: 'Social Media', slug: 'hu-fellow-posts', image: null, placeholder: 'HU Fellow Posts', hasCaseStudy: true },
...
const PROJECT_LIST = [
  ...
  { slug: 'yotor-marketing', name: 'Yotor Marketing', category: 'Social Media', heroImage: 'assets/case-yotor-marketing-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-yotor-marketing-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for Yotor Marketing are in progress.', overview2: '' },
  { slug: 'gara-innovational-bootcamp', name: 'Gara Innovational Bootcamp', category: 'Social Media', heroImage: 'assets/case-gara-innovational-bootcamp-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-gara-innovational-bootcamp-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for Gara Innovational Bootcamp are in progress.', overview2: '' },
  { slug: 'peace-campaign', name: 'Peace Campaign', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for the Peace Campaign are in progress.', overview2: '', gallery: new Array(5) },
  ...
  { slug: 'hu-fellow-posts', name: 'HU Fellow Posts', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for HU Fellow Posts are in progress.', overview2: '', gallery: new Array(5) },
  { slug: 'church-posts', name: 'Church Posts', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for Church Posts are in progress.', overview2: '', gallery: new Array(5) },
