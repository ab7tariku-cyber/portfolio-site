...
const WORK_DATA = [
  ...
  { name: 'Gospel Week', category: 'Social Media', slug: 'gospel-week', image: 'assets/hero-gospel-week.png', placeholder: 'Gospel Week post', hasCaseStudy: true },
  ...
  { name: 'African Holding Group Event Materials', category: 'Print & Editorial', slug: 'ahg-general-assembly', image: 'assets/hero-ahg-general-assembly.png', placeholder: 'AHG Event Materials asset', hasCaseStudy: true },
  { name: 'Purity Magazine', category: 'Print & Editorial', slug: 'purity-magazine', image: 'assets/hero-purity-magazine.png', placeholder: 'Purity Magazine spread', hasCaseStudy: true },
  { name: 'Cafe and Restaurant', category: 'Interior Design & Visualization', slug: 'cafe-and-restaurant', image: 'assets/hero-cafe-and-restaurant.png', placeholder: 'Cafe and restaurant visualization', hasCaseStudy: true },
  { name: 'Hotel Rooms', category: 'Interior Design & Visualization', slug: 'hotel-rooms', image: 'assets/hero-hotel-rooms.png', placeholder: 'Hotel rooms visualization', hasCaseStudy: true },
  { name: 'Podcast Studio', category: 'Interior Design & Visualization', slug: 'podcast-studio', image: 'assets/hero-podcast-studio.png', placeholder: 'Podcast studio visualization', hasCaseStudy: true },
  { name: 'Juice House', category: 'Interior Design & Visualization', slug: 'juice-house', image: 'assets/hero-juice-house.png', placeholder: 'Juice house visualization', hasCaseStudy: true },
];
...
const PROJECT_LIST = [
  ...
  { slug: 'ahg-general-assembly', name: 'African Holding Group Event Materials', category: 'Print', heroImage: 'assets/case-ahg-general-assembly-hero.png', gallery: Array.from({ length: 8 }, (_, i) => 'assets/case-ahg-general-assembly-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Print and event materials for African Holding Group.', overview1: 'This project involved designing a wide range of print and event materials for African Holding Group. I developed various visual assets, including brochures, banners, badges, and other promotional and event-related materials.', overview2: "The designs were created with a consistent visual identity to ensure that every printed material worked together and effectively represented the company's brand during different events and activities." },
  { slug: 'purity-magazine', name: 'Purity Magazine', category: 'Print', heroImage: 'assets/case-purity-magazine-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-purity-magazine-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'An A5 publication for the Sisters Ministry at HU Fellowship.', overview1: 'Purity Magazine is an A5 publication designed for the Sisters Ministry at Hawassa University Fellowship. The project focused on creating an attractive, engaging, and interactive layout that makes the content visually appealing and enjoyable to read.', overview2: 'Through thoughtful typography, layout composition, imagery, and visual hierarchy, the magazine was designed to create a meaningful and engaging experience for its readers.' },
  { slug: 'cafe-and-restaurant', name: 'Cafe and Restaurant', category: 'Interior Design', heroImage: 'assets/case-cafe-and-restaurant-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-cafe-and-restaurant-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Interior design and visualization for a café and restaurant.', overview1: 'This project involved the interior design and visualization of a café and restaurant featuring a dedicated bakery area and an inviting outdoor dining space. I focused on creating a warm and engaging atmosphere through spatial planning, custom lighting, and material selection.', overview2: 'I also modeled key architectural elements, including the distinctive block façade and lighting features, and produced the final visualizations using V-Ray.' },
  { slug: 'hotel-rooms', name: 'Hotel Rooms', category: 'Interior Design', heroImage: 'assets/case-hotel-rooms-hero.png', gallery: Array.from({ length: 6 }, (_, i) => 'assets/case-hotel-rooms-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Color-driven interiors for a hotel room concept.', overview1: 'This hotel room design project explored how color can transform the atmosphere and identity of an interior space. Each room was developed with a different color tone while maintaining a consistent design language and sense of comfort.', overview2: 'The spaces were designed and visualized with attention to materials, lighting, furniture, and mood, with the final renders produced using Enscape.' },
  { slug: 'podcast-studio', name: 'Podcast Studio', category: 'Interior Design', heroImage: 'assets/case-podcast-studio-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-podcast-studio-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'A modern, function-first podcast studio design.', overview1: 'This project focused on designing a modern and visually engaging podcast studio that supports both functionality and creative expression. The space was designed and modeled in SketchUp, with careful consideration given to the layout, lighting, atmosphere, and overall visual identity of the studio.', overview2: 'The final design was brought to life through realistic Enscape visualizations.' },
  { slug: 'juice-house', name: 'Juice House', category: 'Interior Design', heroImage: 'assets/case-juice-house-hero.png', gallery: Array.from({ length: 6 }, (_, i) => 'assets/case-juice-house-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Lighting design for a vibrant juice house interior.', overview1: 'This project focused on the visualization and lighting design of a vibrant juice house interior. The goal was to create an energetic and welcoming atmosphere that reflects freshness and creates an engaging customer experience.', overview2: 'Using Enscape, I developed realistic renders with particular attention to lighting, materials, spatial ambiance, and the overall character of the space.' },
];
