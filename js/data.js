...
const WORK_DATA = [
  ...
  { name: 'Gara Innovational Bootcamp', category: 'Social Media', slug: 'gara-innovational-bootcamp', image: null, placeholder: 'Gara Innovational Bootcamp post', hasCaseStudy: true },
...
const PROJECT_LIST = [
  ...
  { slug: 'yotor-marketing', name: 'Yotor Marketing', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for Yotor Marketing are in progress.', overview2: '', gallery: new Array(5) },
  { slug: 'gara-innovational-bootcamp', name: 'Gara Innovational Bootcamp', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for Gara Innovational Bootcamp are in progress.', overview2: '', gallery: new Array(3) },
  ...
  { slug: 'gospel-week', name: 'Gospel Week', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for Gospel Week are in progress.', overview2: '', gallery: new Array(3) },
  { slug: 'hu-fellow-posts', name: 'HU Fellow Posts', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for HU Fellow Posts are in progress.', overview2: '', gallery: new Array(3) },
  { slug: 'church-posts', name: 'Church Posts', category: 'Social Media', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for Church Posts are in progress.', overview2: '', gallery: new Array(3) },
