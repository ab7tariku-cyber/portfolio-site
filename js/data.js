...
const WORK_DATA = [
  ...
  { name: 'African Holding Group — General Assembly', category: 'Print & Editorial', slug: 'ahg-general-assembly', image: 'assets/hero-ahg-general-assembly.png', placeholder: 'AHG General Assembly asset', hasCaseStudy: true },
  ...
  { name: 'Juice House', category: 'Interior Design & Visualization', slug: 'juice-house', image: null, placeholder: 'Juice house visualization', hasCaseStudy: true },
];
...
const PROJECT_LIST = [
  ...
  { slug: 'ahg-general-assembly', name: 'African Holding Group — General Assembly', category: 'Print', heroImage: null, gallery: Array.from({ length: 8 }, (_, i) => 'assets/case-ahg-general-assembly-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for the AHG General Assembly are in progress.', overview2: '' },
  { slug: 'purity-magazine', name: 'Purity Magazine', category: 'Print', heroImage: 'assets/case-purity-magazine-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-purity-magazine-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for Purity Magazine are in progress.', overview2: '' },
  { slug: 'cafe-and-restaurant', name: 'Cafe and Restaurant', category: 'Interior Design', heroImage: 'assets/case-cafe-and-restaurant-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-cafe-and-restaurant-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for this Cafe and Restaurant visualization are in progress.', overview2: '' },
  { slug: 'hotel-rooms', name: 'Hotel Rooms', category: 'Interior Design', heroImage: 'assets/case-hotel-rooms-hero.png', gallery: Array.from({ length: 6 }, (_, i) => 'assets/case-hotel-rooms-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for this Hotel Rooms visualization are in progress.', overview2: '' },
  { slug: 'podcast-studio', name: 'Podcast Studio', category: 'Interior Design', heroImage: 'assets/case-podcast-studio-hero.png', gallery: Array.from({ length: 5 }, (_, i) => 'assets/case-podcast-studio-mockup-' + String(i + 1).padStart(2, '0') + '.png'), headline: 'Case study write-up coming soon.', overview1: 'Full project details for this Podcast Studio visualization are in progress.', overview2: '' },
  { slug: 'juice-house', name: 'Juice House', category: 'Interior Design', heroImage: null, headline: 'Case study write-up coming soon.', overview1: 'Full project details for this Juice House visualization are in progress.', overview2: '', gallery: new Array(6) },
];
